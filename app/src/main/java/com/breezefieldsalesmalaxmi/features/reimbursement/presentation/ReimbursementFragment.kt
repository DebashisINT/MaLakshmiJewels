package com.breezefieldsalesmalaxmi.features.reimbursement.presentation
...
import com.breezefieldsalesmalaxmi.app.utils.AppUtils.Companion.convertFromRightToReverseFormatWithTime
import com.breezefieldsalesmalaxmi.app.utils.AppUtils.Companion.getFormattedDateForApi
import com.breezefieldsalesmalaxmi.app.utils.AppUtils.Companion.hideSoftKeyboard
import com.breezefieldsalesmalaxmi.app.utils.CustomTextWatcher
import com.breezefieldsalesmalaxmi.app.utils.PermissionUtils
import com.breezefieldsalesmalaxmi.app.utils.ProcessImageUtils_v1
...
import com.breezefieldsalesmalaxmi.features.reimbursement.api.ReimbursementConfigRepoProvider
import com.breezefieldsalesmalaxmi.features.reimbursement.api.applyapi.ApplyReimbursementRepoProvider
import com.breezefieldsalesmalaxmi.features.reimbursement.api.configfetchapi.ReimbursementConfigFetchRepoProvider
import com.breezefieldsalesmalaxmi.features.reimbursement.api.reimbursement_list_api.ReimbursementListRepoProvider
import com.breezefieldsalesmalaxmi.features.reimbursement.api.reimbursementshopapi.ReimbursementShopRepoProvider
import com.breezefieldsalesmalaxmi.features.reimbursement.model.*
import com.breezefieldsalesmalaxmi.features.reimbursement.model.reimbursement_shop.ReimbursementShopDataModel
import com.breezefieldsalesmalaxmi.features.reimbursement.model.reimbursement_shop.ReimbursementShopResponseModel
import com.breezefieldsalesmalaxmi.features.reimbursement.model.reimbursementlist.ReimbursementListDataModel
import com.breezefieldsalesmalaxmi.features.reimbursement.model.reimbursementlist.ReimbursementListDetailsModel
import com.breezefieldsalesmalaxmi.features.reimbursement.model.reimbursementlist.ReimbursementListResponseModel
...
class ReimbursementFragment : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    private fun initView(view: View) {
        ...
        //attachbreezefieldsalesmalaxmiData()
...
//                            XLog.d("ReimbursementConfigApiResponse ERROR: " + error.localizedMessage)
    ...
    private fun attachbreezefieldsalesmalaxmiData() {
