...
import com.breezefieldsalesmalaxmi.app.*
import com.breezefieldsalesmalaxmi.app.NewFileUtils.browseDocuments
import com.breezefieldsalesmalaxmi.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesmalaxmi.app.NewFileUtils.getExtension
import com.breezefieldsalesmalaxmi.app.domain.*
import com.breezefieldsalesmalaxmi.app.types.DashboardType
import com.breezefieldsalesmalaxmi.app.types.FragType
import com.breezefieldsalesmalaxmi.app.types.TopBarConfig
import com.breezefieldsalesmalaxmi.app.uiaction.DisplayAlert
import com.breezefieldsalesmalaxmi.app.utils.*
import com.breezefieldsalesmalaxmi.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsalesmalaxmi.base.BaseResponse
import com.breezefieldsalesmalaxmi.base.presentation.BaseActivity
import com.breezefieldsalesmalaxmi.base.presentation.BaseFragment
import com.breezefieldsalesmalaxmi.features.NewQuotation.*
import com.breezefieldsalesmalaxmi.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalesmalaxmi.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalesmalaxmi.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesmalaxmi.features.SearchLocation.locationInfoModel
import com.breezefieldsalesmalaxmi.features.TA.ViewAllTAListFragment
import com.breezefieldsalesmalaxmi.features.achievement.AchievementFragment
import com.breezefieldsalesmalaxmi.features.activities.presentation.*
import com.breezefieldsalesmalaxmi.features.addAttendence.*
import com.breezefieldsalesmalaxmi.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesmalaxmi.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesmalaxmi.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesmalaxmi.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesmalaxmi.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesmalaxmi.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesmalaxmi.features.addshop.presentation.AddShopFragment
import com.breezefieldsalesmalaxmi.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesmalaxmi.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesmalaxmi.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesmalaxmi.features.alarm.model.AlarmData
import com.breezefieldsalesmalaxmi.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesmalaxmi.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesmalaxmi.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesmalaxmi.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesmalaxmi.features.attendance.AttendanceFragment
import com.breezefieldsalesmalaxmi.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesmalaxmi.features.attendance.model.AttendanceRequest
import com.breezefieldsalesmalaxmi.features.attendance.model.AttendanceResponse
import com.breezefieldsalesmalaxmi.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesmalaxmi.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesmalaxmi.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesmalaxmi.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesmalaxmi.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesmalaxmi.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesmalaxmi.features.billing.presentation.BillingListFragment
import com.breezefieldsalesmalaxmi.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesmalaxmi.features.chat.model.ChatListDataModel
import com.breezefieldsalesmalaxmi.features.chat.model.ChatUserDataModel
import com.breezefieldsalesmalaxmi.features.chat.model.GroupUserDataModel
import com.breezefieldsalesmalaxmi.features.chat.presentation.*
import com.breezefieldsalesmalaxmi.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesmalaxmi.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesmalaxmi.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesmalaxmi.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalesmalaxmi.features.commondialog.presentation.CommonDialog
import com.breezefieldsalesmalaxmi.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalesmalaxmi.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalesmalaxmi.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalesmalaxmi.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalesmalaxmi.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalesmalaxmi.features.contacts.ActivityDtlsFrag
import com.breezefieldsalesmalaxmi.features.contacts.AddOpptFrag
import com.breezefieldsalesmalaxmi.features.contacts.ContactDtls
import com.breezefieldsalesmalaxmi.features.contacts.ContactGr
import com.breezefieldsalesmalaxmi.features.contacts.ContactsAddFrag
import com.breezefieldsalesmalaxmi.features.contacts.ContactsFrag
import com.breezefieldsalesmalaxmi.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesmalaxmi.features.contacts.SchedulerViewFrag
import com.breezefieldsalesmalaxmi.features.contacts.TemplateAddFrag
import com.breezefieldsalesmalaxmi.features.contacts.TemplateViewFrag
import com.breezefieldsalesmalaxmi.features.contacts.ViewCrmOpptFrag
import com.breezefieldsalesmalaxmi.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesmalaxmi.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesmalaxmi.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesmalaxmi.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesmalaxmi.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalesmalaxmi.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesmalaxmi.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesmalaxmi.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesmalaxmi.features.document.presentation.DocumentListFragment
import com.breezefieldsalesmalaxmi.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesmalaxmi.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesmalaxmi.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesmalaxmi.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesmalaxmi.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesmalaxmi.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesmalaxmi.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesmalaxmi.features.home.presentation.HomeFragment
import com.breezefieldsalesmalaxmi.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesmalaxmi.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesmalaxmi.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesmalaxmi.features.lead.LeadFrag
import com.breezefieldsalesmalaxmi.features.lead.ViewLeadFrag
import com.breezefieldsalesmalaxmi.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesmalaxmi.features.leaveapplynew.LeaveHome
import com.breezefieldsalesmalaxmi.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesmalaxmi.features.localshops.LocalShopListFragment
import com.breezefieldsalesmalaxmi.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesmalaxmi.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesmalaxmi.features.location.*
import com.breezefieldsalesmalaxmi.features.location.api.LocationRepoProvider
import com.breezefieldsalesmalaxmi.features.location.model.*
import com.breezefieldsalesmalaxmi.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalesmalaxmi.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalesmalaxmi.features.login.ShopFeedbackEntity
import com.breezefieldsalesmalaxmi.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalesmalaxmi.features.login.presentation.LoginActivity
import com.breezefieldsalesmalaxmi.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalesmalaxmi.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesmalaxmi.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesmalaxmi.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesmalaxmi.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesmalaxmi.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesmalaxmi.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesmalaxmi.features.member.MapViewForTeamFrag
import com.breezefieldsalesmalaxmi.features.member.model.TeamLocDataModel
import com.breezefieldsalesmalaxmi.features.member.model.TeamShopListDataModel
import com.breezefieldsalesmalaxmi.features.member.presentation.*
import com.breezefieldsalesmalaxmi.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesmalaxmi.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesmalaxmi.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesmalaxmi.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesmalaxmi.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesmalaxmi.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesmalaxmi.features.myjobs.presentation.*
import com.breezefieldsalesmalaxmi.features.mylearning.MyLearningFragment
import com.breezefieldsalesmalaxmi.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesmalaxmi.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalesmalaxmi.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalesmalaxmi.features.nearbyshops.model.ShopData
import com.breezefieldsalesmalaxmi.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalesmalaxmi.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesmalaxmi.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesmalaxmi.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesmalaxmi.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesmalaxmi.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesmalaxmi.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesmalaxmi.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesmalaxmi.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesmalaxmi.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesmalaxmi.features.newcollectionreport.*
import com.breezefieldsalesmalaxmi.features.notification.NotificationFragment
import com.breezefieldsalesmalaxmi.features.orderITC.CartListFrag
import com.breezefieldsalesmalaxmi.features.orderITC.OrderListFrag
import com.breezefieldsalesmalaxmi.features.orderITC.ProductListFrag
import com.breezefieldsalesmalaxmi.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsalesmalaxmi.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsalesmalaxmi.features.orderITC.ViewOrdDtls
import com.breezefieldsalesmalaxmi.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesmalaxmi.features.orderList.NewOrderListFragment
import com.breezefieldsalesmalaxmi.features.orderList.OrderListFragment
import com.breezefieldsalesmalaxmi.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesmalaxmi.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesmalaxmi.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesmalaxmi.features.orderhistory.TimeLineFragment
import com.breezefieldsalesmalaxmi.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsalesmalaxmi.features.orderhistory.model.FetchLocationRequest
import com.breezefieldsalesmalaxmi.features.orderhistory.model.FetchLocationResponse
import com.breezefieldsalesmalaxmi.features.orderhistory.model.LocationData
import com.breezefieldsalesmalaxmi.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesmalaxmi.features.performance.GpsStatusFragment
import com.breezefieldsalesmalaxmi.features.performance.PerformanceFragment
import com.breezefieldsalesmalaxmi.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldsalesmalaxmi.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldsalesmalaxmi.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldsalesmalaxmi.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesmalaxmi.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesmalaxmi.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesmalaxmi.features.photoReg.*
import com.breezefieldsalesmalaxmi.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesmalaxmi.features.quotation.presentation.*
import com.breezefieldsalesmalaxmi.features.reimbursement.presentation.*
import com.breezefieldsalesmalaxmi.features.report.presentation.*
import com.breezefieldsalesmalaxmi.features.returnsOrder.*
import com.breezefieldsalesmalaxmi.features.settings.presentation.SettingsFragment
import com.breezefieldsalesmalaxmi.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesmalaxmi.features.shopdetail.presentation.*
import com.breezefieldsalesmalaxmi.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesmalaxmi.features.stock.StockDetailsFragment
import com.breezefieldsalesmalaxmi.features.stock.StockListFragment
import com.breezefieldsalesmalaxmi.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesmalaxmi.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalesmalaxmi.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesmalaxmi.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesmalaxmi.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesmalaxmi.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesmalaxmi.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesmalaxmi.features.survey.SurveyFrag
import com.breezefieldsalesmalaxmi.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesmalaxmi.features.survey.SurveyViewFrag
import com.breezefieldsalesmalaxmi.features.task.presentation.AddTaskFragment
import com.breezefieldsalesmalaxmi.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesmalaxmi.features.task.presentation.EditTaskFragment
import com.breezefieldsalesmalaxmi.features.task.presentation.TaskListFragment
import com.breezefieldsalesmalaxmi.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesmalaxmi.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesmalaxmi.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesmalaxmi.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesmalaxmi.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.CartFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalesmalaxmi.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalesmalaxmi.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesmalaxmi.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesmalaxmi.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesmalaxmi.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesmalaxmi.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesmalaxmi.features.weather.presentation.WeatherFragment
import com.breezefieldsalesmalaxmi.mappackage.MapActivity
import com.breezefieldsalesmalaxmi.mappackage.MapActivityWithoutPath
import com.breezefieldsalesmalaxmi.mappackage.SendBrod
import com.breezefieldsalesmalaxmi.widgets.AppCustomEditText
import com.breezefieldsalesmalaxmi.widgets.AppCustomTextView
...
import com.breezefieldsalesmalaxmi.features.login.api.opportunity.OpportunityRepoProvider
import com.breezefieldsalesmalaxmi.features.login.model.NewSettingsResponseModel
import com.breezefieldsalesmalaxmi.features.mylearning.AllTopicsWiseContents
import com.breezefieldsalesmalaxmi.features.mylearning.BookmarkFetchResponse
import com.breezefieldsalesmalaxmi.features.mylearning.BookmarkFrag
import com.breezefieldsalesmalaxmi.features.mylearning.BookmarkPlayFrag
import com.breezefieldsalesmalaxmi.features.mylearning.KnowledgeHubAllVideoList
import com.breezefieldsalesmalaxmi.features.mylearning.LeaderboardLmsFrag
import com.breezefieldsalesmalaxmi.features.mylearning.LmsQuestionAnswerSet
import com.breezefieldsalesmalaxmi.features.mylearning.MyLearningAllVideoList
import com.breezefieldsalesmalaxmi.features.mylearning.MyLearningTopicList
import com.breezefieldsalesmalaxmi.features.mylearning.MyLearningVideoPlay
import com.breezefieldsalesmalaxmi.features.mylearning.MyPerformanceFrag
import com.breezefieldsalesmalaxmi.features.mylearning.MyTopicsWiseContents
import com.breezefieldsalesmalaxmi.features.mylearning.NotificationLMSFragment
import com.breezefieldsalesmalaxmi.features.mylearning.SearchLmsFrag
import com.breezefieldsalesmalaxmi.features.mylearning.SearchLmsKnowledgeFrag
import com.breezefieldsalesmalaxmi.features.mylearning.SearchLmsLearningFrag
import com.breezefieldsalesmalaxmi.features.mylearning.VideoPlayLMS
import com.breezefieldsalesmalaxmi.features.mylearning.apiCall.LMSRepoProvider
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalesmalaxmilogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmalaxmilogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldsalesmalaxmi/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldsalesmalaxmilogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldsalesmalaxmilogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldsalesmalaxmilogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
