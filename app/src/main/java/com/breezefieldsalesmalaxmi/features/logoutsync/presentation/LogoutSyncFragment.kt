package com.breezefieldsalesmalaxmi.features.logoutsync.presentation
...
import com.breezefieldsalesmalaxmi.app.AppDatabase
...
import com.breezefieldsalesmalaxmi.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalesmalaxmi.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalesmalaxmi.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalesmalaxmi.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalesmalaxmi.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalesmalaxmi.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefieldsalesmalaxmi.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalesmalaxmi.features.orderhistory.model.*
...
import com.breezefieldsalesmalaxmi.features.quotation.model.AddQuotInputModel
import com.breezefieldsalesmalaxmi.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesmalaxmi.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalesmalaxmi.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezefieldsalesmalaxmi.features.stock.api.StockRepositoryProvider
import com.breezefieldsalesmalaxmi.features.stock.model.AddStockInputParamsModel
import com.breezefieldsalesmalaxmi.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesmalaxmi.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldsalesmalaxmi.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldsalesmalaxmi.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalesmalaxmi.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalesmalaxmi.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalesmalaxmi.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalesmalaxmi.mappackage.SendBrod
import com.breezefieldsalesmalaxmi.widgets.AppCustomTextView
import com.breezefieldsalesmalaxmi.MonitorService
import com.breezefieldsalesmalaxmi.MySingleton
import com.breezefieldsalesmalaxmi.app.AlarmReceiver
...
import com.breezefieldsalesmalaxmi.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalesmalaxmi.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldsalesmalaxmi.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldsalesmalaxmi.features.orderITC.SyncDeleteOpptL
...
import com.breezefieldsalesmalaxmi.features.orderITC.SyncOpptProductL
import com.breezefieldsalesmalaxmi.features.orderITC.SyncOrd
import com.breezefieldsalesmalaxmi.features.orderITC.SyncOrdProductL
import com.breezefieldsalesmalaxmi.features.performance.model.Gps_status_list
import com.breezefieldsalesmalaxmi.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalesmalaxmi.features.returnsOrder.ReturnProductList
import com.breezefieldsalesmalaxmi.features.returnsOrder.ReturnRequest
import com.breezefieldsalesmalaxmi.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmalaxmilogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmalaxmilogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmalaxmilogsample/log.zip").path);
